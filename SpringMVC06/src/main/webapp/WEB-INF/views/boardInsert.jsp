...
<body>
	<div class="container">
		...
		<div class="panel panel-warning">
			<div class="panel-heading">Board Writing Page</div>
			...
			<!-- 
				...
				1. GET (Query String)
					...
					- boardList.do?title=오늘쌀국수먹음&contents=쥔쨔마쉿음&writer=임은영
					- 모든 요청을 할 때 따로 변경하지 않는한 기본 요청방식은 GET방식이다
					- 장점 : 속도가 빠르다, url공유가 가능하다
